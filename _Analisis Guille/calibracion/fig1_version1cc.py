...
#pylab.savefig('fig1_version1c.eps', format='eps', dpi=300, bbox_inches='tight')

np.savetxt('fig1_version1c.dat', np.transpose([tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,sensor_bis_delta]), delimiter='\t', newline='\n')
