...
#ax1.plot(tiempo,vernier-vernier_min,lw=0.7,color='darkorange',label=r'Vernier (cuadrado)')
#ax1.plot(tiempo,sensor-sensor_min,lw=0.7,color='steelblue',label=r'Sensor (cuadrado)')

ax1.plot(tiempo_bis,theta_bis,lw=0.1,color='gray',linestyle='-',label=r'$\theta(v-v_\mathrm{min})$ ($v_\mathrm{min}=2.58$)')
ax1.plot(tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,lw=0.3,color='firebrick',label=r'Vernier')
ax1.plot(tiempo_bis,sensor_bis,lw=0.3,color='darkorange',label=r'Sensor')
...
pylab.savefig('fig1_version1.eps', format='eps', dpi=300, bbox_inches='tight')
