...
ax1.text(29.5,2.2,r't=(29,33)',size=4)
ax1.set_xlim(29, 33)
ax1.set_xticks([])

ax2.plot(tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,lw=0.3,color='firebrick',label=r'Vernier sin el offset')
ax2.plot(tiempo_bis,sensor_bis_delta,lw=0.3,color='darkorange',label=r'Sensor sin el offset')
ax2.text(38.5,2.2,r't=(38,42)',size=4)
ax2.set_xlim(38, 42)
ax2.set_xticks([])

ax3.plot(tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,lw=0.3,color='firebrick',label=r'Vernier sin el offset')
ax3.plot(tiempo_bis,sensor_bis_delta,lw=0.3,color='darkorange',label=r'Sensor sin el offset')
ax3.text(71.5,2.2,r't=(71,75)',size=4)
ax3.set_xlim(71, 75)
ax3.set_xticks([])

ax4.plot(tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,lw=0.3,color='firebrick',label=r'Vernier sin el offset')
ax4.plot(tiempo_bis,sensor_bis_delta,lw=0.3,color='darkorange',label=r'Sensor sin el offset')
ax4.text(79.5,2.2,r't=(79,83)',size=4)
ax4.set_xlim(79, 83)
ax4.set_xticks([])
...
pylab.savefig('fig3_version1.eps', format='eps', dpi=300, bbox_inches='tight')
