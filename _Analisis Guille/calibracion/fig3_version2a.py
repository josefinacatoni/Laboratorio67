...
data2= np.genfromtxt('./cuadradoS13_a.dat', delimiter = '\t')	
...
x=(vernier_bis-vernier_bis_min)*theta_bis
y=sensor_bis_delta
...
ax1.plot(x[0:70],y[0:70],lw=0.4,color='black',label=r'primer ciclo')
ax1.plot(x[69:110],y[69:110],lw=0.4,color='gray',label=r'segundo ciclo')
ax1.plot(x[109:146],y[109:146],lw=0.4,color='olive',label=r'tercer ciclo')
ax1.plot(x[145:181],y[145:181],lw=0.4,color='steelblue',label=r'cuarto ciclo')
ax1.plot(x[180:218],y[180:218],lw=0.4,color='firebrick',label=r'quinto ciclo')
ax1.plot(x[217:263],y[217:263],lw=0.4,color='darkorange',label=r'sexto ciclo')


legend = plt.legend(loc='lower right',prop={'size':2.5})
...
pylab.savefig('fig3_version2a.eps', format='eps', dpi=300, bbox_inches='tight')

np.savetxt('fig3_version2a.dat', np.transpose([tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,sensor_bis_delta]), delimiter='\t', newline='\n')
