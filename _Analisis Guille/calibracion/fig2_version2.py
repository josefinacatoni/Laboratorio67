...
ax1.plot(vernier_bis,sensor_bis,'o',markersize=0.1,color='steelblue',label=r'Calibraci\'on bis (cuadrado)')
...
pylab.savefig('fig2_version2.eps', format='eps', dpi=300, bbox_inches='tight')
