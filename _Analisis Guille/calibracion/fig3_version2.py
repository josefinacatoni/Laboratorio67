...
pylab.savefig('fig3_version2.eps', format='eps', dpi=300, bbox_inches='tight')

np.savetxt('fig3_version2.dat', np.transpose([tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,sensor_bis_delta]), delimiter='\t', newline='\n')
