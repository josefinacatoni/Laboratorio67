...
data2= np.genfromtxt('./cuadradoS13bis_d.dat', delimiter = '\t')	
...
pylab.savefig('fig3_version1d.eps', format='eps', dpi=300, bbox_inches='tight')

np.savetxt('fig3_version1d.dat', np.transpose([tiempo_bis,(vernier_bis-vernier_bis_min)*theta_bis,sensor_bis_delta]), delimiter='\t', newline='\n')
