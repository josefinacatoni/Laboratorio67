...
data1= np.genfromtxt('./26062019_tarde.txt', delimiter = '\t')	
...
ax1.plot(milestone+60,levels,linestyle='-',lw=0.3,color='black',zorder=1,label=r'Liniers')
ax1.plot(milestone+1200,levels,linestyle='--',lw=0.4,color='gray',zorder=1,label=r'Moron')
ax1.plot(milestone+1560,levels,linestyle='-.',lw=0.4,color='gray',zorder=1,label=r'(contacto espalda)')
ax1.plot(milestone+1620,levels,linestyle=':',lw=0.4,color='gray',zorder=1,label=r'Ituzaingo')
...
pylab.savefig('fig_series_2_version0cc.eps', format='eps', dpi=300, bbox_inches='tight')
