...
ax1.plot(milestone+780,levels,linestyle='-',lw=2.0,color='yellow',zorder=1)
ax1.plot(milestone+766,levels,linestyle='-',lw=0.4,color='gray',zorder=1,label=r'Ramos (corte)')
ax1.plot(milestone+792,levels,linestyle='-',lw=0.4,color='gray',zorder=1,label=r'Ramos (corte)')
ax1.plot(milestone+900,levels,linestyle='--',lw=0.4,color='gray',zorder=1,label=r'Haedo')
ax1.plot(milestone+1200,levels,linestyle='-.',lw=0.4,color='gray',zorder=1,label=r'Moron')
...
legend = plt.legend(loc='upper right',prop={'size':4})
ax1.set_xlim(0, 2500)
ax1.set_ylim(0, 400)
...
pylab.savefig('fig_series_1_version0c.eps', format='eps', dpi=300, bbox_inches='tight')
