...
ax1.plot(steps1,histo1_smooth,lw=0.7,color='olive',zorder=1,label=r'sensor 1')
ax1.plot(steps2,histo2_smooth,lw=0.7,color='orange',zorder=1,label=r'sensor 2')
ax1.plot(steps3,histo3_smooth,lw=0.7,color='steelblue',zorder=1,label=r'sensor 3')
...
pylab.savefig('fig_histo_3_version0.eps', format='eps', dpi=300, bbox_inches='tight')
