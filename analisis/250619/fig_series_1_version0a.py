...
histo1_smooth=sliding_median(data1[:,1],20)
histo2_smooth=sliding_median(data1[:,2],20)
histo3_smooth=sliding_median(data1[:,3],20)
histo4_smooth=sliding_median(data1[:,4],20)
...
pylab.savefig('fig_series_1_version0a.eps', format='eps', dpi=300, bbox_inches='tight')
