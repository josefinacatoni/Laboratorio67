...
ax1.plot(0.2*time,histo2-histo2_smooth,lw=0.3,color='orange',zorder=1,label=r'sensor 2 (median)')
#ax1.plot(0.2*time,histo2_smooth_2,linestyle='--',lw=0.7,color='orange',zorder=1,label=r'sensor 2 (mean)')
ax1.plot(0.2*time,histo3-histo3_smooth,lw=0.3,color='steelblue',zorder=1,label=r'sensor 3 (median)')
#ax1.plot(0.2*time,histo3_smooth_2,linestyle='--',lw=0.7,color='steelblue',zorder=1,label=r'sensor 3 (mean)')
ax1.plot(0.2*time,histo1-histo1_smooth,lw=0.3,color='olive',zorder=1,label=r'sensor 1 (median)')
...
ax1.set_title(r'Raw data minus median ($\pm80\,$sec)')


pylab.savefig('fig_series_1_version0d.eps', format='eps', dpi=300, bbox_inches='tight')
