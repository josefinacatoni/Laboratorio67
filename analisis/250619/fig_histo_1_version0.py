...
ax1.loglog(steps1,histo1,lw=0.7,color='olive',zorder=1,label=r'sensor 1')
ax1.loglog(steps2,histo2,lw=0.7,color='orange',zorder=1,label=r'sensor 2')
ax1.loglog(steps3,histo3,lw=0.7,color='steelblue',zorder=1,label=r'sensor 3')
...
pylab.savefig('fig_histo_1_version0.eps', format='eps', dpi=300, bbox_inches='tight')
