...
ax1.plot(0.2*time,histo2-histo2_smooth_2,lw=0.3,color='orange',zorder=1,label=r'sensor 2')
ax1.plot(0.2*time,histo3-histo3_smooth_2,lw=0.3,color='steelblue',zorder=1,label=r'sensor 3')
ax1.plot(0.2*time,histo1-histo1_smooth_2,lw=0.3,color='olive',zorder=1,label=r'sensor 1')

legend = plt.legend(loc='upper right',prop={'size':4})
#ax1.set_ylim(0, 0.005)
ax1.set_xlabel(r'time (sec.)')
ax1.set_ylabel(r'Levels')
ax1.set_title(r'Raw data minus mean ($\pm80\,$sec)')


pylab.savefig('fig_series_1_version0e.eps', format='eps', dpi=300, bbox_inches='tight')
